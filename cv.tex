...
\begin{minipage}[t]{0.25\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	   \colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{\href{https://www.linkedin.com/in/adam-krcek-819136194/}{Adam}}}}}} %
	   \colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{\href{https://www.linkedin.com/in/adam-krcek-819136194/}{Krček}}}}}}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\icon{MapMarker}{12}{\href{https://goo.gl/maps/vDnfPVTCrPVNdQbB9}{Ostrava}}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	\begin{barchart}{5.5}
		\baritem{\href{https://github.com/skrcka?tab=repositories&q=&type=&language=python&sort=}{Python}}{90}
		\baritem{\href{https://github.com/skrcka?tab=repositories&q=&type=&language=javascript&sort=}{JS/TS}}{80}
		...
		\baritem{\href{https://github.com/skrcka?tab=repositories&q=&type=&language=rust&sort=}{Rust}}{65}
		\baritem{Haskell}{30}
	\end{barchart}
\end{minipage}
